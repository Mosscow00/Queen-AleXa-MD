...
case 'webtonsearch': case 'webtoon':
    ...
    XeonBotInc.sendMessage(m.chat, { image: { url: r_text[i] }, caption: '👸 *Made by Queen-Alexa*' }, { quoted: m })
    }
    break
    case 'random': {
    var r_text = new Array ();

    r_text[0] = `https://api.xteam.xyz/textpro/neon?text=${text}&APIKEY=ba33b82cd3755c3e`
    r_text[1] = `https://api.xteam.xyz/textpro/snowtext?text=${text}&APIKEY=72404708ebbadaee`
    r_text[2] = `https://api.xteam.xyz/textpro/3dgradient?text=${text}&APIKEY=fb3afa34fd0eddbf`
    r_text[3] = `https://api.xteam.xyz/textpro/3dluxury?text=${text}&APIKEY=ba69027eb3dc7987`
    r_text[4] = `https://api.xteam.xyz/textpro/3dgradient?text=${text}&APIKEY=00e0e1bf4c7dde0d`
    r_text[5] = `https://api.xteam.xyz/textpro/blackpink?text=${text}&APIKEY=8a8ebc8d8b932805`
    r_text[6] = `https://api.xteam.xyz/textpro/realisticvintage?text=${text}&APIKEY=98b033c6ef54b61a`
    r_text[7] = `https://api.xteam.xyz/textpro/cloudsky?text=${text}&APIKEY=8a2b52654b55c3f6`
    r_text[8] = `https://api.xteam.xyz/textpro/sandsummerbeach?text=${text}&APIKEY=79cf7ab4e6598752`
    r_text[9] = `https://api.xteam.xyz/textpro/glitch?text=${text}&APIKEY=2d7fce02fc14400a`
    r_text[10] = `https://api.xteam.xyz/textpro/metaldarkgold?text=${text}&APIKEY=981a4ef70f9f08c4`
    r_text[11] = `https://api.xteam.xyz/textpro/goldfoilballon?text=${text}&APIKEY=2376fa7786a47519` 
...
View List Of Messages With ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
            ...
            case 'work public': {
                ...
                reply('👩‍🦰ඔබේ Bot පොදු ආකාරයට ක්‍රියාකරය')
            }
            break
            case 'work private': {
                if (!isCreator) return replay(`${mess.owner}`)
                XeonBotInc.public = false
                reply('👩‍🦰ඔබේ Bot පෞද්ගලික ආකාරයට ක්‍රියාකරයි.')
            }
            break
            case 'pinnng': case 'btstatus': case 'statubot': {
...
break
            case 'list': case 'menux': case 'help': {
            	timestampe = speed();
latensie = speed() - timestampe
                anu = ``
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
 ...
 *│⚙️BOT SETTINGS*
 ...
 ╰───────────●●►*` 
            ...
            break
            case 'github': case 'script': {
                reply(`GitHub : https://github.com/ChamodKeshan/Queen-Alexa`)
            }
            break
            case 'system': {
